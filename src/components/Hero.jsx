...
const Hero = () => {
  return (
    <div className="mt-24 max-w-[100%]  mx-auto relative">
            ...
            >
                ...
                >
                    ...
                    <div className="flex gap-6 flex-row text-4xl md:text-6xl text-purple-400 z-20">
                        <motion.a whileHover={{ scale: 1.2 }} href="https://github.com/devtayyab04">
                            <AiOutlineGithub/>
                        </motion.a>

                        <motion.a whileHover={{ scale: 1.2 }} href="https://www.linkedin.com/in/m-tayyab-960b4b257/">
                            <AiOutlineLinkedin/>
                        </motion.a>
                    </div>
                </motion.div>
